  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 p-4">
      <form
        noValidate
        onSubmit={onSubmit}
        className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl border border-emerald-100"
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Join RISN Store</h1>
          <p className="text-gray-600">Create your account to start shopping sustainably</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 bg-white px-4 py-3 focus-within:border-emerald-500 focus-within:ring-1 focus-within:ring-emerald-500">
              <input
                required
                name="email"
                type="email"
